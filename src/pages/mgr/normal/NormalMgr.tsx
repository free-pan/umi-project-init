...
import styles from './NormalMgr.less';
...
import { TableListItem } from '@/pages/mgr/normal/data';
import {
  addRule,
  queryRule,
  removeRule,
  updateRule,
} from '@/pages/mgr/normal/service';
...
const NormalMgr: React.FC<NormalMgrProps> = (props) => {
